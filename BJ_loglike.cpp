...
const double BJ_loglike::BJ_LL_P0_MIN    = 0.;
const double BJ_loglike::BJ_LL_P0_MAX    = 1.;

const double BJ_loglike::BJ_LL_INIT_P1   = 0.;
const double BJ_loglike::BJ_LL_P1_MIN    = 0.;
const double BJ_loglike::BJ_LL_P1_MAX    = 1.;
